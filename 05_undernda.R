...
locations_undernda <- locations_processed |>
...
# locations_undernda |> View()
locations_undernda |> head(n = 10)
locations_undernda |> glimpse()


# Optionally save the result as CSV
write_csv(locations_undernda, file.path(data_dir, "locations_undernda.csv"))
# Optionally save the result as RDS
write_rds(locations_undernda, file.path(data_dir, "locations_undernda.rds"))
